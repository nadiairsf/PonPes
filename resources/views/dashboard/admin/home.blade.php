...
@section('content')
   ...
   <?php
   $pengajar = DB::table('data_gurus')->count();
   ?>
         ...
         <div class="card o-hidden">
            ...
            <div class="ecommerce-widgets media">
               <div class="media-body">
                  <p class="f-w-500 font-roboto">Konsultasi<span class="badge pill-badge-primary ms-3">Jumlah</span></p>
                  <h4 class="f-w-500 mb-0 f-20"><span class="counter">{{$konsultasi}}</span></h4>
               </div>
