         ...
         <div class="dt-ext table-responsive">
            <div id="custom-button_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4">
               ...
               <div id="custom-button_filter" class="dataTables_filter">
                  <label>Search:<input type="text" class="form-control form-control-sm" aria-controls="custom-button" id="myInput" onkeyup="myFunction()" placeholder="Cari nama kelas"></label>
               </div>
