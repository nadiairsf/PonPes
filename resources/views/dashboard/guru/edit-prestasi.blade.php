                  ...
                  <div class="modal-dialog" role="document">
                     <div class="modal-content">
                        ...
                        <div class="modal-body">
                           <form class="card" action="/guru/create-prestasi/{{$d->id}}" method="post" >
                           @csrf
					            {{ csrf_field() }}
                              <div class="mb-3">
                                 <label class="col-form-label" for="message-text">Keterangan Prestasi</label>
                                 <input class="form-control" id="message-text" name="ket" required>
                              </div>
                        </div>
             ...
             @foreach ($table as $t )
               <tbody>
                  <tr>
                     ...
                     <td>{{$t->ket}}</td>
                     <td>
                     <a href="/guru/hapus-prestasi/{{$t->id}}" class="button delete-confirm">
                        <button class="btn btn-secondary">
