      ...
      <div class="col-xl-5 p-0">
         <div class="login-card">
            <div>
               ...
               <form class="theme-form"  action="{{ route('guru.check') }}" method="post">
                  @if (Session::get('fail'))
                  ...
                  <p class="mt-4 mb-0 text-center"><a class="ms-2" href="{{ route('guru.forgot.password.form') }}">Lupa Password ?</a></p>
               </form>
               </div>
            </div>
         </div>
