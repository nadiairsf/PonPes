		...
		<div class="row">
			<div class="col-xl-6">
				<div class="card">
                  ...
                  <a href="/santri/edit-profil">
                     <button class="btn btn-primary btn-sm" style="" tabindex="0" aria-controls="custom-button" data-bs-original-title="" title="">
...
<div class="container-fluid">
   ...
   <?php
   $id =  Auth::id();
   $countz = DB::table('Data_santris')->where('Data_santris.id_santris',$id)
