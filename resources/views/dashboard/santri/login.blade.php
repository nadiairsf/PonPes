         ...
         <div class="login-card">
            <div>
              ...
              <div class="login-main"> 
                <form class="theme-form"  action="{{ route('santri.check') }}" method="post">
                  @if (Session::get('fail'))
                  ...
                  <p class="mt-4 mb-0 text-center"><a class="ms-2" href="{{ route('santri.forgot.password.form') }}">Lupa Password ?</a></p>
                </form>
              </div>
            </div>
         </div>
