      ...
      <ul class="nav-menus">
        ...
        <li class="profile-nav onhover-dropdown p-0 me-0">
          ...
          <ul class="profile-dropdown onhover-show-div">
            <li><a href="{{route('admin.changeAccount')}}"><i data-feather="user"></i><span>Account </span></a></li>
            <li><a href="{{route('admin.changePassword')}}"><i data-feather="settings"></i><span>Settings</span></a></li>
