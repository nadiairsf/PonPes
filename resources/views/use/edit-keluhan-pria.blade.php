...
<div class="container-fluid">
	<div class="edit-profile">
		<div class="row">
			<div class="col-xl-12">
         @foreach ($data as $d )
            <form class="card" action="/admin/diary/update-keluhan-pria/{{$d->id}}" method="post" >
                              ...
                              <div class="row">
                                 <div class="col-md-6">
                                    ...
                                    <label for="">Perubahan Fisik pada Bagian Reporoduksi</label>            
                                       ...
                                       @else
                                       @php
                                          $fis = json_decode($data[0]->fisik_pria);
                                       @endphp
                                       <select id="fisik_pria" name="fisik_pria[]" class="form-select mb-3" multiple="multiple">
                                          <option value="terdapat perubahan suara"
                                          <?php for ($i = 0; $i < count($fis); $i++) {
                                          if($fis[$i] == 'terdapat perubahan suara') echo 'selected';} ?>>Terdapat perubahan suara (suara lebih dalam/serak)</option>
                                          <option value="tumbuh kumis/jenggot"
                                          <?php for ($i = 0; $i < count($fis); $i++) {
                                          if($fis[$i] == 'tumbuh kumis/jenggot') echo 'selected';} ?>>Tumbuh kumis/jenggot</option>
                                          <option value="tumbuh jakun"
                                          <?php for ($i = 0; $i < count($fis); $i++) {
                                          if($fis[$i] == 'tumbuh jakun') echo 'selected';} ?>>Tumbuh jakun</option>
                                          <option value="tumbuh rambut kemaluan"
                                          <?php for ($i = 0; $i < count($fis); $i++) {
                                          if($fis[$i] == 'tumbuh rambut kemaluan') echo 'selected';} ?>>Tumbuh rambut kemaluan</option>    
                                          <option value="sudah mimpi basah"
                                          <?php for ($i = 0; $i < count($fis); $i++) {
                                          if($fis[$i] == 'sudah mimpi basah') echo 'selected';} ?>>Sudah mimpi basah </option>    
                                          <option value="memiliki daya tarik dengan lawan jenis"
                                          <?php for ($i = 0; $i < count($fis); $i++) {
                                          if($fis[$i] == 'memiliki daya tarik dengan lawan jenis') echo 'selected';} ?>>Memiliki daya tarik dengan lawan jenis </option>   
                                          <option value="lainnya"
                                          <?php for ($i = 0; $i < count($fis); $i++) {
                                          if($fis[$i] == 'lainnya') echo 'selected';} ?>>Lainnya</option>     
                                       </select> 
                                       @endif
                                       </div>
                                    </div>
