			...
			<div class="row">
				<div class="col-sm-12">
					<div class="card">
						...
						<div class="card-body">
                        @foreach ( $data as $d )
						<form  class="theme-form mega-form" action="/admin/konsultasi/update/{{$d->id}}" method="post"  >
                            @csrf
                            {{ csrf_field() }}
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control p-3" name="guru" value="{{$d->guru}}" hidden></input>
                                <input class="form-control p-3" value="{{$d->nama}}"></input>
