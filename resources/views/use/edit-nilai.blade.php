	...
	<div class="row">
		<div class="col-sm-12 col-xl-9">
            ...
            <div class="card">
                  ...
                  @endif
                  <form class="form theme-form"  action="/admin/capaian/update-nilai/{{$data[0]->id}}" method="post">
                  @csrf
                  {{ csrf_field() }}
                    <div class="card-body">
                      <div class="row">
                    ...
                    <div class="card-footer text-end">
                      <div class="col-sm-9 offset-sm-3">
                        ...
                        <a href="">
                           <button class="btn btn-light" type="reset" value="Cancel" data-bs-original-title="" title="">Cancel</button>
                        </a>
                      </div>
                    </div>
                  </form>
