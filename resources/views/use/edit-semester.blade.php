			...
			<div class="row">
				<div class="col-sm-12">
					<div class="card">
						...
						<div class="card-body">
                  @foreach ($data as $d )
						<form  class="theme-form mega-form" action="/admin/capaian/semester/update/{{$d->id}}" method="post"  >
                            @csrf
                            {{ csrf_field() }}
                            <div class="mb-3">
                                <label class="col-form-label">Mata Pelajaran</label>
                             
                                <input class="form-control p-3" type="text" name="tahun" value="{{$d->tahun}}" ></input>
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control p-3" type="text" name="nama" value="{{$d->nama}}" ></input>
