	...
	<div class="row">
		<div class="col-sm-12 col-xl-9">
            ...
            <div class="card">
                  ...
                  @endif
                  <form class="form theme-form"  action="{{ route('admin.createNilai') }}" method="post">
                  @csrf
                  {{ csrf_field() }}
                    <div class="card-body">
                      <div class="row">
                        ...
                        <div class="mb-3 row">
                            ...
                            @endforeach
                            <div class="col-sm-1">
                              <input class="form-control" type="text" data-bs-original-title="" title="" name="tg1[]" value="{{old('tg1')}}">
                            </div>
                            <div class="col-sm-1">
                              <input class="form-control" type="text" data-bs-original-title="" title="" name="tg2[]" value="{{old('tg2')}}">
                            </div>
                            <div class="col-sm-1">
                              <input class="form-control" type="text" data-bs-original-title="" title="" name="tg3[]" value="{{old('tg3')}}">
                            </div>
                            <div class="col-sm-1">
                              <input class="form-control" type="text" data-bs-original-title="" title="" name="ph1[]" value="{{old('ph1')}}">
                            </div>
                            <div class="col-sm-1">
                              <input class="form-control" type="text" data-bs-original-title="" title="" name="ph2[]" value="{{old('ph2')}}">
                            </div>
                            <div class="col-sm-1">
                              <input class="form-control" type="text" data-bs-original-title="" title="" name="ph3[]" value="{{old('ph3')}}">
                            </div>
                            <div class="col-sm-2">
